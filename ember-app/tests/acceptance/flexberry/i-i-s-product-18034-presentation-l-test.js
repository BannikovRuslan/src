...
moduleForAcceptance('[AGAT] Acceptance | i i s product 18034 presentation l');

test('testing i-i-s-product-18034-presentation-l', function(assert) {
  visit('/i-i-s-product-18034-presentation-l');
